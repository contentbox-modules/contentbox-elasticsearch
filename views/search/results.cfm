		...
		<cfloop array="#args.results.getResults()#" index="i" item="result">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>
						<a href="#( result.contentType == "Entry" ? "/" & cb.getBlogEntryPoint() & "/" : '/')##result.slug#" class="panel-title">#highlightSearchTerm( args.results.getSearchTerm(), result.title )#</a>
						...
						<cfelse>
							<i class="fa-lg #( result.contentType == 'Page' ? 'far fa-file' : 'fas fa-rss' )# pull-right"></i>
						</cfif>
					</h4>
				</div>
